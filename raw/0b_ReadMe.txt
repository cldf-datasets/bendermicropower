...
Author, contact, & funding information 
...
Funding
Synergy Grant of the European Research Council for the project "Evolution of Cognitive Tools for Quantification (QUANTA)", proposal number 951388.

Folder description
The folder contains four documents, one of which in two different formats: 
* this overview, 
...
Data file structure
Data are entered in a single data sheet consisting of 20 columns. The first five of these columns contain information for identifying and classifying the languages or language variants:
* The column "ID" provides a unique alphanumeric identifier for each language variant for which data on power numerals was obtained. In two cases, this includes two distinct descriptions each of systems in the same language variant, provided by different authors.
* The columns "lang_Code" and "lang_Name" contain the Glottocodes and the names, respectively, for each of the analysed languages, following the Glottolog conventions; see https://glottolog.org/ (last accessed on 2021-03-27).
...
* The column "Orth" indicates whether, for the numerals of that language (in columns from 10^1 to 10^10), orthography was fully retained = "0" or had to be adjusted = "1".
...
The source file contains bibliographic information on the sources used to generate the data file – mostly grammars and vocabularies of these languages, linguistic analyses, and ethnographic descriptions – as well as all additional sources referred to in the comments. 
Entry names consist of the last name of the first author and the year of publication (of the edition used). The bibliographic information specified follows BibTech conventions.


(3) Transcription sheet
...
The transcription sheet details which specific signs were retained, and which had to be replaced. In the latter case, a scan of the letter in original orthography was inserted. As noted earlier, ligature markings were ignored.
